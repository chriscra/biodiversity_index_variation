...
\begin{figure}
\includegraphics[width=1\textwidth]{/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/SI_fig_facet_r_extra_composites} \caption{Comparing the four existing composite indices included in our main text to three additional composites: 1) a combination of four key habitat priorities (\emph{habitats}), 2) plant species richness per ecoregion (\emph{plants}), and 3) our own stylized bird conservation composite (\emph{bird\_composite}).}\label{fig:all-composites}
\end{figure}
...
Pebesma, Edzer. 2021. \emph{{sf: Simple Features for R}}. \url{https://cran.r-project.org/package=sf}.
...
Ross, Noam. 2018. \emph{{fasterize: Fast Polygon to Raster Conversion}}. \url{https://cran.r-project.org/package=fasterize}.
...
Wickham, Hadley. 2018. \emph{{pryr: Tools for Computing on the Language}}. \url{https://cran.r-project.org/package=pryr}.

\leavevmode\hypertarget{ref-R-tidyverse}{}%
---------. 2019. \emph{{tidyverse: Easily Install and Load the 'Tidyverse'}}. \url{https://cran.r-project.org/package=tidyverse}.

\leavevmode\hypertarget{ref-R-reshape2}{}%
---------. 2020. \emph{{reshape2: Flexibly Reshape Data: A Reboot of the Reshape Package}}. \url{https://cran.r-project.org/package=reshape2}.
