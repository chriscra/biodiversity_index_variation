...
# save data.tables as backup, and as .RData files
...
fwrite(conv_b_pure_dt, file = fp(p_mod_output, "mod_result_backup_conv_b_pure_dt.csv"))
fwrite(conv_b_dt, file = fp(p_mod_output, "mod_result_backup_conv_b_dt.csv"))
fwrite(conv_by_dt, file = fp(p_mod_output, "mod_result_backup_conv_by_dt.csv"))
fwrite(conv_bc_dt, file = fp(p_mod_output, "mod_result_backup_conv_bc_dt.csv"))
fwrite(conv_bt_dt, file = fp(p_mod_output, "mod_result_backup_conv_bt_dt.csv"))
fwrite(conv_byct_dt, file = fp(p_mod_output, "mod_result_backup_conv_byct_dt.csv"))
fwrite(conv_z50_dt, file = fp(p_mod_output, "mod_result_backup_conv_z50_dt.csv"))
