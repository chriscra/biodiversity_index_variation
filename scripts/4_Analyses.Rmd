...
# start png call here. 
# bp weights here:
pdf(paste0(p_plots, "/ms_final/","ms_fig_2_facet_r_", weight, "_wide.pdf"),
    width = 8, height = 5, # units = "in", res = 300
)

# for z50, all
pdf(paste0(p_plots, "/si/","SI_fig_facet_r_", weight, "_wide.pdf"),
    width = 8, height = 5)
...
# save version for SI
# -------------------------------------------------------
pdf(paste0(p_plots, "/si/", "ms_fig_4_robustness_SI", ".pdf"), # for SI
    width = 7, height = 4#, units = "in", res = 400
    )
...
# The second figure includes the b, and the remaining four weighting scenarions (by, bc, bt, and byct).
