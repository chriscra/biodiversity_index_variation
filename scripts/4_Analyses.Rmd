...
# save:
png(paste0(p_plots, "/ms_v5/", "ms_fig_3_jac_w_bp", ".png"), 
...
png(paste0(p_plots, "/ms_v5/", "ms_fig_4_robustness_SI", ".png"),
    width = 7, height = 4, units = "in", res = 400)
...
# start png call here. 
# bp weights here:
png(paste0(p_plots, "/ms_v5/","ms_fig_2_facet_r_", weight, "_wide.png"),
    width = 8, height = 5,
    units = "in", res = 300)

# for z50, all
# png(paste0(p_plots, "/ms_v5/","SI_fig_facet_r_", weight, "_wide.png"),    
#     width = 8, height = 5,
#     units = "in", res = 300)
