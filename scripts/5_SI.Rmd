...
nocite: |
  @RStudioTeam2020, @R-base, @R-agroEcoTradeoff, @Estes2015, @R-lmisc, @R-raster, @R-rasterVis, @R-rgdal, @R-sf, @R-sp, @R-gdalUtils, @R-data.table, @R-tictoc, @R-fasterize, @lwgeom, @R-magrittr, @R-reshape2, @R-cowplot, @R-tidyverse, @R-knitr, @R-spatstat, @R-rmarkdown, @Xie2018, @Xie2020, @R-bookdown, @R-pryr, @R-kableExtra, @R-scales, @R-viridis
---
...
# load and reorganize factor levels for jaccard similarity values, including renaming some levels (richness <- types)
...
We ran the model through five additional scenarios that progressively shared weight between biodiversity and yield, carbon loss, and transportation cost, allowing these factors to also influence conversion decisions. These five scenarios also allowed for spatially accurate and heterogeneous yields:
...
Species range maps, richness maps, biodiversity indices, and the resulting model outputs were processed in RStudio version `r rstudioapi::versionInfo()$version`, using `r R.Version()$version.string`, using the `agroEcoTradeoff`, `data.table`, `sf`, `raster`, `dtraster`, `fasterize`, `tidyverse`, `lmisc`,  `rgdal`, `sp`, `gdalUtils`, `rasterVis`, `tictoc`,  `lwgeom`, `magrittr`, `reshape2`, `cowplot`, `knitr`, `spatstat`, `rmarkdown`, `bookdown`, `pryr`, and `viridis` packages.

```{r packages-bib, include = FALSE, eval = FALSE}
knitr::write_bib(x = c(pkgs, lyndon_pkgs), file = 'packages_2021.bib')
```
...
knitr::include_graphics(fp(p_plots, "si/bd_input_maps_1.png"))
```

```{r bd-inputs-10, fig.cap = '(ref:caption-bd-inputs-10)', echo=FALSE}
knitr::include_graphics(fp(p_plots, "si/bd_input_maps_10.png"))
```

```{r bd-inputs-110, fig.cap = '(ref:caption-bd-inputs-110)', echo=FALSE}
knitr::include_graphics(fp(p_plots, "si/bd_input_maps_110.png"))
```
...
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_bp_1.png")
```

```{r conv-maps-10-bp, fig.cap = '(ref:caption-conv-maps-10-bp)', echo=FALSE}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_bp_10.png")
```

```{r conv-maps-110-bp, fig.cap = '(ref:caption-conv-maps-110-bp)', echo=FALSE}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_bp_110.png")
```
...
Figure \@ref(fig:pairwise-jaccard) shows the pairwise Jaccard Similarity values for our primary analysis (*bp*). While these values are included in Fig. 3, this additional figure shows each pairwise value more clearly.
...
ggplot(filter(jac_w_melt, 
  ...
  scale_fill_viridis("Mean Values", discrete = T) # for color blindness
```
...
knitr::include_graphics(fp(p_plots, "si/SI_fig_nnd_bp.png"))
```
...
knitr::include_graphics(fp(p_plots, "si/SI_fig_facet_r_threat_combo.png"))
```
...
knitr::include_graphics(fp(p_plots, "si/ms_fig_4_robustness_SI.png"))
...
# knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_z50.png"))
```

(ref:caption-facet-r-z50) Mean conversion priorities assuming a production target that results in the conversion of ~50% of Zambia (*z50*), placing 100% weight in biodiversity and using average and constant yields across Zambia (compare with Fig. 2). The panels show biodiversity indices within five categories of variation: a) existing biodiversity indices (vertebrate endemism richness, @Estes2016a, @Laurance2014a, and @Damania2015); b) taxonomic groups (mammals, birds, amphibians, and reptiles); c) species richness metrics (all species richness, endemism richness, and small-ranged species richness); d) index combination methods (average, geometric mean, maximum, and multiplication); and e) input resolutions (1 km, 10 km, and 110 km grids). Cell values correspond to the proportion of model runs using that particular factor that convert that cell; 0 is shown in gray, low values in yellow to green, and high values in blue to dark purple. White areas correspond to currently protected, cultivated, or settled areas.

```{r facet-r-z50, fig.cap = '(ref:caption-facet-r-z50)', out.width = "1\\textwidth"}
knitr::include_graphics(fp(p_plots, "si/SI_fig_facet_r_z50_wide.png"))
```
...
knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_order_conv.png"))
```

```{r order-protect, fig.cap = '(ref:caption-order-protect)', out.width = "\\textwidth"}
knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_order_protect.png"))
```
...
(ref:caption-all-composites) Comparing the four existing composite indices included in our main text to three additional composites: 1) a combination of four key habitat priorities (*habitats*), 2) plant species richness per ecoregion (*plants*), and 3) our own stylized bird conservation composite (*bird_composite*).
...
# map_colors <- c("#F2F2F2", viridis(50, direction = -1)) # terrain.colors(50, rev = TRUE)
map_colors
...
png(paste0(p_plots, "/si/","SI_fig_facet_r_extra_composites.png"),    
    width = 8, height = 7,
    units = "in", res = 300)
...
knitr::include_graphics(fp(p_plots, "si/SI_fig_facet_r_extra_composites.png"))
```
...
knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_all.png"))
```

```{r jac-w-b, fig.cap = '(ref:caption-jac-w-b)', out.width = "0.8\\textwidth"}
knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_b.png"))
```

```{r jac-w-by, fig.cap = '(ref:caption-jac-w-by)', out.width = "0.8\\textwidth"}
knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_by.png"))
```

```{r jac-w-bc, fig.cap = '(ref:caption-jac-w-bc)', out.width = "0.8\\textwidth"}
knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_bc.png"))
```

```{r jac-w-bt, fig.cap = '(ref:caption-jac-w-bt)', out.width = "0.8\\textwidth"}
knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_bt.png"))
```

```{r jac-w-byct, fig.cap = '(ref:caption-jac-w-byct)', out.width = "0.8\\textwidth"}
knitr::include_graphics(fp(p_plots, "si/SI_fig_jac_w_byct.png"))
```
...
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_b_1.png")
```

```{r conv-maps-1-by, fig.cap = '(ref:caption-conv-maps-1-by)', echo=FALSE}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_by_1.png")
```

```{r conv-maps-1-bc, fig.cap = '(ref:caption-conv-maps-1-bc)', echo=FALSE}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_bc_1.png")
```

```{r conv-maps-1-bt, fig.cap = '(ref:caption-conv-maps-1-bt)', echo=FALSE}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_bt_1.png")
```

```{r conv-maps-1-byct, fig.cap = '(ref:caption-conv-maps-1-byct)', echo=FALSE}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_byct_1.png")
```

```{r conv-maps-1-z50, fig.cap = '(ref:caption-conv-maps-1-z50)', echo=FALSE}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps/basic_conv_maps_z50_1.png")
```
...
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps_by_category/composites_1_conv_maps.png")
```

```{r conv-maps-types-1, fig.cap = '(ref:caption-conv-maps-types-1)', echo=FALSE, out.height = "0.85\\textheight"}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps_by_category/types_1_conv_maps.png")
```

```{r conv-maps-taxa-all-1, fig.cap = '(ref:caption-conv-maps-taxa-all-1)', echo=FALSE, out.height = "0.9\\textheight"}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps_by_category/taxa_all_1_conv_maps.png")
```

```{r conv-maps-taxa-endemism-1, fig.cap = '(ref:caption-conv-maps-taxa-endemism-1)', echo=FALSE, out.height = "0.9\\textheight"}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps_by_category/taxa_endemism_1_conv_maps.png")
```

```{r conv-maps-taxa-small-1, fig.cap = '(ref:caption-conv-maps-taxa-small-1)', echo=FALSE, out.height = "0.9\\textheight"}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps_by_category/taxa_small_1_conv_maps.png")
```

```{r conv-maps-methods-mb-1, fig.cap = '(ref:caption-conv-maps-methods-mb-1)', echo=FALSE, out.height = "0.9\\textheight"}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps_by_category/methods_mb_1_conv_maps.png")
```

```{r conv-maps-methods-vp-1, fig.cap = '(ref:caption-conv-maps-methods-vp-1)', echo=FALSE, out.height = "0.9\\textheight"}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps_by_category/methods_vp_1_conv_maps.png")
```

```{r conv-maps-methods-ae-1, fig.cap = '(ref:caption-conv-maps-methods-ae-1)', echo=FALSE, out.height = "0.9\\textheight"}
knitr::include_graphics("/Users/christophercrawford/Google Drive/_Projects/Zambia/agroEcoTradeoff/external/plots/si/conv_maps_by_category/methods_ae_1_conv_maps.png")
```
